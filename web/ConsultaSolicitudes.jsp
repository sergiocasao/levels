...
<div id="cuerpo2">
    ...
    <table align="center" id="resultados">
        ...
        <tr><td align="center"><font size="4px" >Folio</font></legend></td><td><font size="4px" >Titulo</legend></td></tr>
        <%String buscar=request.getParameter("buscador");

        ArrayList<Solicitud> lista= BD.obtenerSolicitudes(id);
        for(int i=0;i<lista.size();i++){
            Solicitud obj= new Solicitud();
            obj=lista.get(i);
            %>
            
            <form action="ConsultaUnicaSolicitud.jsp" method="post">
            <tr><td align="center"><font size="4px" ><%=obj.getId()%></font></legend></td><td><font size="4px" ><input type="submit" id="boton9" value="<%=obj.getTitulo()%>"/><input type="hidden" name="id" value="<%=obj.getId()%>"/></td></tr>
            </form>
