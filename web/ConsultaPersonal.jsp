...
<div id="cuerpo2">
    ...
    <table align="center" id="resultados">
        ...
        <%
        int buscar=Integer.parseInt(request.getParameter("id"));
        ArrayList<Profesor> lista= BD.consultaPersonal(buscar);
        for(int i=0;i<lista.size();i++){
            Profesor obj= new Profesor();
            obj=lista.get(i);
            %>
            <form action="irPerfilAdmin.jsp" name="buscar" method="post">
       ...
       %>
               <table align="center">
                   ...
                   <tr align="center"><td><h4 align="center">No se encontro personal</h4></td></tr>
