...
<div id="cuerpo2">
    ...
    <table align="center" id="resultados">
        ...
        ArrayList<Solicitud> lista= BD.obtenerSolicitudesEspecificas(id);
        int solicitudes=0;
        for(int i=0;i<lista.size();i++){
            Solicitud obj= new Solicitud();
            obj=lista.get(i);
            String nombre= BD.obtenerNombre(obj.getIdProf());
            if((BD.obtenerEstado(id)==3 && obj.getIdProfSegAdmin()==0) || (BD.obtenerEstado(id)==4 && obj.getIdProfSegCCB()==0 && obj.getIdProfSegAdmin()!=0) || (BD.obtenerEstado(id)==5 && obj.getIdProfSegQA()==0 && obj.getIdProfSegAdmin()!=0 && obj.getIdProfSegCCB()!=0)){
                solicitudes++;
            %>
            ...
            <%}
               ...
               if(solicitudes==0){%>
               <h4 align="center">No hay solicitudes de cambio registradas para gestion</h1> 
               <%}
               }
        %>
        </table>
