...
public class Cifrado {
 private String Cifrado=new String();
    ...
    private String Llave= new String();
    ...
    public void Ki(){
        ...
        int[] Key= new int[8];
        for(int i=0; i<8;i++){
            //Se hace un random para generar 8 numeros aleatorios
            int numero=(int)(Math.random()*10);
            String caracter=String.valueOf(numero);
            Llave+=caracter;
            //Se pasa cada numero a caracter para poder sacar su ascii segun la tabla
            char carKey=caracter.charAt(0);
            Key[i]=(int)carKey;
    ...
    public String cifrar(String mensaje){
        ...
        String[] Mensajex8= new String[(mensaje.length()/8)];
        for(int i=0;i<Mensajex8.length;i++){
            Mensajex8[i]=mensaje.substring(i*8,((i+1)*(7+1)));
        }
        ...
        for(int i=0;i<Mensajex8.length;i++){
            ...
            for(int l=0;l<8;l++){
                for(int k=0;k<8;k++){
                    this.Cifrado+=String.valueOf(P2[l][k]);
                }
            }
